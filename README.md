...
In addition, [the front-end code](https://github.com/sshfortress/greatfortress) is fully open source and can be taken if required.  
...
# ./install.sh
# setenforce 0 
`If selinux is enabled on the system, you need to disable it` 
```
## How-to-use
