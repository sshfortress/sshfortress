...
char dstname[512], dstpassword[512], dstip[512], dst_port[128], get_query[2048], sshtype[256], audituser[256];
char *local_password;
int local_i;

char sftptmpfile[256], sftpchdir[512], SerNum_buf[256];

int runprogram(char **command);

void sshfs_main(char *port, char *dstname, char *password, char *remote_mount, char *local_mount);
char mysql_host[256], mysql_user[256], mysql_passwd[256], mysql_database[256], fortresss_port[128];

/* tmp command */
char tmp_wfd_logcom[128], tmp_rfd_logcom[128];
struct timeval oldtime;
pid_t sftp_pid;
int judgewinscp;
char *playback_logfile, *timingfile;
/* add */
#endif /* INCLUDES_H */
